/*
    ...
    Source File:      $Source: /share/puhe/cvsroot/paragui/src/widgets/pgwidgetlist.cpp,v $
...
PG_WidgetList::PG_WidgetList(PG_Widget* parent, const PG_Rect& r, const char* style) : PG_ScrollWidget(parent, r, style) {
